...
import com.hq.entity.ColumnEntity;
import com.hq.entity.TableEntity;
...
//		}
		...
		if(template.contains("list.js.vm")){
			return "main" + File.separator + "webapp" + File.separator + "js" + File.separator + moduleName + File.separator + className.toLowerCase() + ".js";
		}
